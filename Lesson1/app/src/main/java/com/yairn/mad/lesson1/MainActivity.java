...
//        Toast.makeText(this, "You Rolled: " + rndImage, Toast.LENGTH_LONG).show();
        Snackbar.make(view, "You Rolled: "  + rndImage, Toast.LENGTH_LONG).show();
        // Will need to add: implementation 'com.android.support:design:28.0.0' to the Gradle to use Snackbars
